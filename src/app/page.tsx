  ...
  return (
    <main className="min-h-screen px-4 py-6 sm:px-6 lg:px-10">
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-6">
        ...
        <section className="panel flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div className="space-y-2">
            <p className="label">Real-time perpetual DEX comparison</p>
            <h2 className="font-display text-3xl italic text-[var(--text-primary)] sm:text-4xl">
              {ticker} Liquidity Dashboard
            </h2>
            <p className="max-w-2xl text-sm text-[var(--text-secondary)]">
              Polling every 1.5 seconds across Hyperliquid, dYdX, Lighter, and AsterDEX.
            </p>
          </div>
